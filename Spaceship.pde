class Spaceship extends Floater  
{
  ...
  public Spaceship() {
    ...
    //corners = 12;
    //int[] xS = {0, 2, 3, 3, 2, 0, -1, -2, -3, -3, -2, -1};
    //int[] yS = {8, 9, 9, -9, -9, -8, -7, -5, -1, 1, 5, 7};
    //int[] xS = {0, -2, -7, -3, -7, -2, 0, 1, 2, 3, 3, 2, 1};
    //int[] yS = {8, 9, 9, 0, -9, -9, -8, -7, -5, -1, 1, 5, 7};
    //int[] yS = {16, 18, 18, 0, -18, -18, -16, -14, -10, -2, 2, 10, 14};
    xCorners = xS;   
    yCorners = yS;
